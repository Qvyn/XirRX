        ...
        try:
            ...
            while self._run:
                ...
                try:
                    ...
                    # Mouse scaling
                    scale = finite_float(getattr(cfg,'pixel_scale',12.0), 12.0, 0.0, 100000.0) * finite_float(sens_eff, 0.0, 0.0, 100000.0)
                    ...
                    cap_tick = finite_int(getattr(cfg,'max_pixels_per_tick',40), 40, 2, 100000)
                    cap_ps   = finite_int(getattr(cfg,'max_pixels_per_second',3600), 3600, 200, 1000000)
