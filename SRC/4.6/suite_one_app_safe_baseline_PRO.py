...
# - Tabs: InputRX, CrossXir, Streamer
...
# Ensure a default window icon exists so QSystemTrayIcon has one
        ...
        for b in (self.btn_input, self.btn_cross, self.btn_stream, self.btn_drift):
        ...
        for w in (self.inputTab, self.crossTab, self.streamTab, self.driftTab):
